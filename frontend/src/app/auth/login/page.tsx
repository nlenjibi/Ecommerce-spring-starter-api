...
const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Handle checkout cart restoration if coming from checkout
      if (callbackUrl === '/checkout') {
        const checkoutCartId = localStorage.getItem('checkout_cart_id');
        if (checkoutCartId) {
          console.log('🔄 Restoring checkout cart:', checkoutCartId);
          localStorage.removeItem('checkout_cart_id');
        }
      }
